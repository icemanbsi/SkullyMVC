...
<head>
	...
	<link href="{$themeUrl}resources/css/admin/stylesheets.css" rel="stylesheet" type="text/css" />
	<!--[if lt IE 10]>
	<link href="{$themeUrl}resources/css/admin/ie.css" rel="stylesheet" type="text/css" />
	<![endif]-->
