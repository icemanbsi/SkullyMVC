...
<div class="header">
	<a href="{url path="admin/home"}" class="logo"></a>
	...
	<div class="buttons">
		...
		<div class="dropdown">
			...
			<div class="body" style="width: 160px;">
				...
				{*</div>*}
				<div class="itemLink">
					<a href="{url path="admin/users/logout"}"><span class="icon-off icon-white"></span> Logoff</a>
				</div>
			</div>
		</div>
		{*<div class="popup">*}
				...
				<div class="row-fluid">
					<div class="row-form">
						<div class="span12">
							...
							<div class="themes">
								<a href="#" data-theme="" class="tip" title="Default"><img src="{$themeUrl}resources/images/admin/themes/default.jpg"/></a>
								<a href="#" data-theme="ssDaB" class="tip" title="DaB"><img src="{$themeUrl}resources/images/admin/themes/dab.jpg"/></a>
								<a href="#" data-theme="ssTq" class="tip" title="Tq"><img src="{$themeUrl}resources/images/admin/themes/tq.jpg"/></a>
								<a href="#" data-theme="ssGy" class="tip" title="Gy"><img src="{$themeUrl}resources/images/admin/themes/gy.jpg"/></a>
								<a href="#" data-theme="ssLight" class="tip" title="Light"><img src="{$themeUrl}resources/images/admin/themes/light.jpg"/></a>
								<a href="#" data-theme="ssDark" class="tip" title="Dark"><img src="{$themeUrl}resources/images/admin/themes/dark.jpg"/></a>
								<a href="#" data-theme="ssGreen" class="tip" title="Green"><img src="{$themeUrl}resources/images/admin/themes/green.jpg"/></a>
								<a href="#" data-theme="ssRed" class="tip" title="Red"><img src="{$themeUrl}resources/images/admin/themes/red.jpg"/></a>
							</div>
						</div>
					</div>
					<div class="row-form">
...
{include file="admin/widgets/mainMenu.tpl"}
...
<div id="default">
	...
	{include file="admin/widgets/userInfo.tpl"}
...
{include file="admin/widgets/breadcrumbs.tpl"}
