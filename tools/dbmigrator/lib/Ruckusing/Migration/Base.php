...
class Ruckusing_Migration_Base
{
    ...
    {
        return $this->_adapter->drop_table($this->_config['table_prefix'].$tbl);
    }
    ...
    {
        return $this->_adapter->rename_table($this->_config['table_prefix'].$name, $this->_config['table_prefix'].$new_name);
    }
    ...
    {
        return $this->_adapter->rename_column($this->_config['table_prefix'].$tbl_name, $column_name, $new_column_name);
    }
    ...
    {
        return $this->_adapter->add_column($this->_config['table_prefix'].$table_name, $column_name, $type, $options);
    }
    ...
    {
        return $this->_adapter->remove_column($this->_config['table_prefix'].$table_name, $column_name);
    }
    ...
    {
        return $this->_adapter->change_column($this->_config['table_prefix'].$table_name, $column_name, $type, $options);
    }
    ...
    {
        return $this->_adapter->add_index($this->_config['table_prefix'].$table_name, $column_name, $options);
    }
    ...
    {
        return $this->_adapter->remove_index($this->_config['table_prefix'].$table_name, $column_name, $options);
    }
    ...
    public function create_table($table_name, $options = array()) {
        return $this->_adapter->create_table($this->_config['table_prefix'].$table_name, $options);
    }
